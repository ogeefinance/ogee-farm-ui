...
import { getProfileContract, getOgeeYieldRabbitContract } from 'utils/contractHelpers'
...
const rabbitContract = getOgeeYieldRabbitContract()
  ...
  try {
    ...
    if (isActive) {
      ...
      Cookies.set(
        ...
        {
          username,
          avatar: `https://ogeeYieldswap.finance/images/nfts/${nft.images.sm}`,
        },
        { domain: 'ogeeYieldswap.finance', secure: true, expires: 30 },
      )
    }
