...
import { Button, Flex, Heading, useModal, Won } from '@ogeefinance/uikit'
import { useProfile } from 'state/hooks'
import useI18n from 'hooks/useI18n'
import ClaimNftAndOytModal, { useCanClaim } from './ClaimGiftModal'
...
const ProfileHeader = () => {
  ...
  const [onPresentClaimGiftModal] = useModal(<ClaimNftAndOytModal onSuccess={checkClaimStatus} />)
