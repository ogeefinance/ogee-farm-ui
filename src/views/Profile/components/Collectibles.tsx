...
import { Heading, Text, Flex, ChevronRightIcon } from '@ogeefinance/uikit'
  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'OgeeYield Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
      ...
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved OgeeYield Collectibles won't be shown here.",
        )}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{TranslateString(999, 'See all approved OgeeYield Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
