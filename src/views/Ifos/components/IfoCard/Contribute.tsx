...
import { Box, Button, Flex, Text, useModal } from '@ogeefinance/uikit'
...
const Contribute: React.FC<ContributeProps> = ({
  ...
  const handleContributeSuccess = (amount: BigNumber) => {
    toastSuccess('Success!', `You have contributed ${getBalanceNumber(amount)} OYT-HT LP tokens to this IDO!`)
