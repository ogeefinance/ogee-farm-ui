...
import { Heading, CardBody, CardFooter, OgeefinanceRoundIcon, TicketRound } from '@ogeefinance/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} OYT`)}
              Icon={OgeefinanceRoundIcon}
            >
