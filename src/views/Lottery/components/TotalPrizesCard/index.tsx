...
import { Heading, Card, CardBody, CardFooter, Text, OgeefinanceRoundIcon, Flex, Skeleton } from '@ogeefinance/uikit'
    ...
    <Card>
      <CardBody>
        ...
        <CardHeading>
          <Left>
            <IconWrapper>
              <OgeefinanceRoundIcon />
            </IconWrapper>
            <PrizeCountWrapper>
              <Text fontSize="14px" color="textSubtle">
                {TranslateString(722, 'Total Pot:')}
              </Text>
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} OYT</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
