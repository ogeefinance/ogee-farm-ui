...
import { getBep20Contract, getOytContract } from 'utils/contractHelpers'
...
export const useTotalSupply = () => {
  ...
  useEffect(() => {
    async function fetchTotalSupply() {
      const oytContract = getOytContract()
      const supply = await oytContract.methods.totalSupply().call()
